import{l as d,d as n}from"./utilidades-bdf508cf.js";function r(o){const i=`
    <p class="text-xl text-bold my-4">${new Date(o.dataPedido).toLocaleDateString("pt-BR",{hour:"2-digit",minute:"2-digit"})}</p>
    <section id="container-pedidos-${o.dataPedido}" class="bg-zinc-300 p-3 rounded-md"></section>
